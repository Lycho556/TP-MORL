...
class GateEnv:
    ...
    def __init__(self, T=10, lead=1, onset=4, gamma=0.95,
        ...
        严格占优：等到 onset 年立项、lead 年后交付，折现指数是 onset+lead=5，
        得 1.6·0.95^5 = 1.24；第 0 年立项则是 0.6·0.95 = 0.57。即门槛实验必须先保证
    ...
    def brute_force_optimum(self):
        ...
        规模 (T − lead + 1)^n（每个单元可选的立项年是 0..T-lead-1，外加"不做"）：
        T=10/n=3 时 lead=1 得 1000 个组合、lead=7 得 64 个，直接枚举即可，
