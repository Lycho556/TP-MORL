...
**两档筛选各算一份，不得混用。** 无初筛档本脚本实测
0.438 / 0.741 / 0.912 / 1.000（随机 / 冻结场贪心 / 完美预报贪心 / oracle），
而 Double-FQI 的 0.904 是**初筛 K=20** 下测的（该档 0.716 / 0.775 / 0.894 /
1.000）；把它们放进同一张阶梯就是拿两套口径拼图。
（更早文档里的 0.726 是旧口径陈值，已作废 —— 一律以本脚本现测为准。）
本脚本把两档都算出来并分开报告：
